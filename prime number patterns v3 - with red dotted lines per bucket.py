        ...
        if gen % PARAMS['PLOT_REFRESH'] == 0:
            ...
            for i in range(len(x)):
                if isprime(i + 1):
                    ...
                    #comment out this part if you dont want to see the red dots that mark the proyection in the bucket in the X axis of the prime in the curve 
                    ax2.vlines(x[i], 0, y[i], colors='red', linestyles='dotted')
